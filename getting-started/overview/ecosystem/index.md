...
- **[Platform](./platform)** — the backend core: API gateway, 14 domain microservices, and 7 event-driven workers. Understand the request pipeline, consistent CRUD surface, and how all components connect.
